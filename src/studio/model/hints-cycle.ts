...
export const CYCLE_HINTS: Record<string, Hint> = {
  ...
  "cycle.split": ["Split the longest", "halves the longest phase and names the new half"],
  "cycle.even": ["Evenly spaced", "spreads every boundary evenly around the cycle"],
  "cycle.period": ["Period", "days in one full cycle — writes calendar.moons[i].cycleDays"],
  "cycle.epoch": ["Phase at epoch", "where the moon stands on day 0 — writes calendar.moons[i].phaseAtEpoch"],
