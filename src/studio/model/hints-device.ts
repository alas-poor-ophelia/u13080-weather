...
export const DEVICE_HINTS: Record<string, Hint> = {
  ...
  "device.gate.source": ["Gate", "the tag this device is restricted to"],
  "device.gate.amount": ["Amount", "gate strength: 1 silences the device outside the tag, 0 is no gate"],
